...
public enum RuneStatType implements StringRepresentable {
    ...
    HEALTH("health", 2.0F, 4.0F, 1.0F, 2.0F, 0.0F, false, 0.1F),
    ...
    TOUGHNESS("toughness", 2.0F, 4.0F, 1.0F, 2.0F, 20.0F, false, 0.1F),
    FREEZING_CHANCE("freezing_chance", 6, 12, 3, 6, 35.0F),
    LEECHING_CHANCE("leeching_chance", 1.0F, 3.0F, 1.0F, 3.0F, 18.0F, true, 0.1F),
    BONUS_CHANCE("bonus_chance", 1.0F, 4.0F, 1.0F, 2.0F, 35.0F, false, 0.1F),
